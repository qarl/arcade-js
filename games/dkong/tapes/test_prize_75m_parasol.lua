-- PRIZE gate fixture (75m_parasol): collect the parasol on board 3.
-- coin@399 start@459; board-3 pre-set held 464..1463; Mario -> (0x55,0xc8) @1600; hold P1 Right 1600..1800.
-- Mirrors tools/prize_suite.py's emit --poke/--input. Pickup = exact grid match
-- (Mario 0x6203==prizeX & 0x6205==prizeY) at prize (0x5b,0xc8).
...
_G.__prz=emu.add_machine_frame_notifier(function()
 ...
 if f>=1600 and f<=1601 then mem:write_u8(0x6203,0x55);mem:write_u8(0x6205,0xc8) end
