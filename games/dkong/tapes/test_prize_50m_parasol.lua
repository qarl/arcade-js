-- PRIZE gate fixture (50m_parasol): collect the parasol on board 2.
-- coin@399 start@459; board-2 pre-set held 464..1463; Mario -> (0x50,0xa0) @1600; hold P1 Right 1600..1800.
-- Mirrors tools/prize_suite.py's emit --poke/--input. Pickup = exact grid match
-- (Mario 0x6203==prizeX & 0x6205==prizeY) at prize (0x53,0xa0).
...
_G.__prz=emu.add_machine_frame_notifier(function()
 ...
 if f>=1600 and f<=1601 then mem:write_u8(0x6203,0x50);mem:write_u8(0x6205,0xa0) end
