-- PRIZE gate fixture (50m_hat): collect the hat on board 2.
-- coin@399 start@459; board-2 pre-set held 464..1463; hold P1 Right 1600..1800.
-- Mirrors tools/prize_suite.py's emit --poke/--input. Pickup = exact grid match
-- (Mario 0x6203==prizeX & 0x6205==prizeY) at prize (0x8b,0xf0).
