...
local coin=I2.fields["Coin 1"];local start=I2.fields["1 Player Start"];local inp=I0.fields["P1 Button 1"]
...
_G.__ts=emu.add_machine_frame_notifier(function()
 ...
 if f>=1600 and f<=1601 then mem:write_u8(0x6203,0x60);mem:write_u8(0x6205,0xd0) end
