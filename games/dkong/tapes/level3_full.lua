...
local f = 0
_G.__l3f_sub = emu.add_machine_frame_notifier(function()
  f = f + 1
  coin:set_value((f >= 399 and f < 400) and 1 or 0)
  start:set_value((f >= 459 and f < 460) and 1 or 0)
  if f >= 464 and f <= 1463 then
    mem:write_u8(0x604A, 0x76); mem:write_u8(0x604B, 0x3A); mem:write_u8(0x6049, 0x03)
    mem:write_u8(0x622A, 0x76); mem:write_u8(0x622B, 0x3A)
    mem:write_u8(0x6227, 0x03); mem:write_u8(0x6229, 0x03)
  end
end)
