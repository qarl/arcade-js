-- PRIZE gate fixture (75m_purse): collect the purse on board 3.
-- coin@399 start@459; board-3 pre-set held 464..1463; Mario -> (0x15,0x80) @1600; hold P1 Right 1600..1800.
-- Mirrors tools/prize_suite.py's emit --poke/--input. Pickup = exact grid match
-- (Mario 0x6203==prizeX & 0x6205==prizeY) at prize (0x1b,0x80).
...
_G.__prz=emu.add_machine_frame_notifier(function()
 ...
 if f>=1600 and f<=1601 then mem:write_u8(0x6203,0x15);mem:write_u8(0x6205,0x80) end
